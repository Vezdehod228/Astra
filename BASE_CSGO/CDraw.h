...
public:
	...
	unsigned long m_ESPFont, m_WatermarkFont, m_MenuFont, m_ListItemFont, TabPanelFont, ForCheckbox, Testing, ForMiniTabPanel, ForTabPanel, NameCheatFont, nameESP, dropDownFont;
private:
};